...
BeginDialog Court_Order_Request_Dialog, 0, 0, 366, 95, "Court Order Request"
  EditBox 75, 5, 70, 15, prism_case_number
  EditBox 255, 5, 65, 15, date_court_order_requested
  ComboBox 100, 30, 115, 15, "Click here to enter county name"+chr(9)+"CP"+chr(9)+"NCP", requested_from
  DropListBox 270, 30, 85, 15, "Select one..."+chr(9)+"Email"+chr(9)+"Fax"+chr(9)+"Telephone"+chr(9)+"Mail"+chr(9)+"SIR Email"+chr(9)+"Inter-Office", requested_via_droplistbox
  EditBox 65, 50, 85, 15, court_order_number
  EditBox 260, 50, 100, 15, order_type
  EditBox 75, 70, 90, 15, worker_signature
  ButtonGroup ButtonPressed
    OkButton 255, 75, 50, 15
    CancelButton 310, 75, 50, 15
  Text 220, 30, 50, 10, "Requested Via:"
  Text 5, 10, 70, 10, "Prism Case Number:"
  Text 5, 75, 70, 10, "Sign your CAAD note:"
  Text 160, 10, 100, 10, "Date Court Order Requested:"
  Text 220, 55, 40, 10, "Order Type:"
  Text 5, 55, 65, 10, "Court File Number:"
