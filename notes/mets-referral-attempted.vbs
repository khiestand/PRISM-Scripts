...
call changelog_update("02/22/2017", "Initial version.", "Kelly Hiestand, Wright County")
...
'THE DIALOG-------------------------------------------------------------------------------------------------------------
BeginDialog mets_referral_dialog, 0, 0, 316, 170, "METS/MAO Referral Attempted"
  EditBox 80, 5, 95, 15, prism_case_number
  EditBox 75, 25, 75, 15, mets_case_number
  EditBox 245, 25, 60, 15, date_ref_attempt
  EditBox 115, 45, 135, 15, children
  EditBox 115, 65, 135, 15, error_msg
  EditBox 50, 90, 200, 15, other_notes
  DropListBox 110, 120, 140, 15, "Select one..."+chr(9)+"Create Worklist"+chr(9)+"Generate Email", action_dropdown
  EditBox 70, 145, 120, 15, worker_signature
  ButtonGroup ButtonPressed
    OkButton 205, 145, 50, 15
    CancelButton 260, 145, 50, 15
  ...
  Text 5, 115, 100, 25, "Do you want to create a worklist or generate an email to the worker with this info?"
  Text 5, 70, 105, 10, "Error Message Rec'd in METS:"
  Text 5, 10, 75, 10, "PRISM Case Number:"
  Text 5, 50, 105, 10, "Referral Attempted for Child/ren:"
EndDialog
...
'NEED THE GENERATE EMAIL PIECE HERE, WILL LEARN FROM ILSE ON 3-9-17 SCOTT CO HACKATHON.
