...
ReDim Preserve cs_scripts_array(script_num)
SET cs_scripts_array(script_num) = NEW cs_script
cs_scripts_array(script_num).script_name		= "METS/MA Referral Attempted"
cs_scripts_array(script_num).category			= "notes"
cs_scripts_array(script_num).description		= "Creates CAAD note for when a METS/MA Referral is attempted and failed."
cs_scripts_array(script_num).release_date		= #03/09/2017#
cs_scripts_array(script_num).scriptwriter		= ""
